"""Exact full-hand joint-inference posterior (Appendix: joint-inference variant).

Origin: Phase-1 rebuttal computation A (2026-07); promoted into src/ for v8.
...
cancel from the marginal. Hence:
  - if NO other hand card is hint-constrained, joint marginal == the
    paper's per-card marginal posterior exactly;
...
from src.game_engine import ALL_COLORS, ALL_RANKS, CARD_DISTRIBUTION, HanabiState
